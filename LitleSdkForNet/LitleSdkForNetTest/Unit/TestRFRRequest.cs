...
namespace Litle.Sdk.Test.Unit
{
    ...
    class TestRFRRequest
    {
        ...
        public void testInitialization()
        {
            ...
            Assert.AreEqual($"C:\\MockRequests{Path.DirectorySeparatorChar}Requests{Path.DirectorySeparatorChar}", rfrRequest.getRequestDirectory());
            Assert.AreEqual($"C:\\MockResponses{Path.DirectorySeparatorChar}Responses{Path.DirectorySeparatorChar}", rfrRequest.getResponseDirectory());
